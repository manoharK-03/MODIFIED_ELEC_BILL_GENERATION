        ...
        <div class="bill-content">
            ...
            <div class="charges-section">
                <div class="charge-row">
                    ...
                    <span class="charge-value">₹<?php echo number_format($bill['basic_charge'], 2); ?></span>
                </div>
                <div class="charge-row">
                    <span class="charge-label">Energy Charge (<?php echo $bill['units_consumed']; ?> × ₹<?php echo $bill['rate_per_unit']; ?>):</span>
                    <span class="charge-value">₹<?php echo number_format($bill['energy_charge'], 2); ?></span>
                </div>
                <div class="total-row charge-row">
                    <span class="charge-label">Total Amount:</span>
                    <span class="charge-value">₹<?php echo number_format($bill['total_amount'], 2); ?></span>
                </div>
            </div>
