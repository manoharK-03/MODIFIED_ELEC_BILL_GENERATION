...
// Fetch employees (exclude password)
$employees = $conn->query("
    SELECT employee_id, username, full_name, email, created_at
    FROM employees
");
?>
<!DOCTYPE html>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                <a href="../modules/add_employee.php" class="btn btn-primary" style="text-align: center; text-decoration: none;">
                    👨‍💼 Add Employee
                </a>
                <a href="../modules/register_user.php" class="btn btn-success" style="text-align: center; text-decoration: none;">
                    ➕ Register User
                </a>
                <a href="../modules/view_all_bills.php" class="btn btn-primary" style="text-align: center; text-decoration: none;">
                    📋 View All Bills
                </a>
            </div>
        </div>
